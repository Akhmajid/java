...
public class SimulationRadarDijkstra implements UpdateEventSender{
	...
	public void run() throws Exception { 
		Terrain[][]t=TerrainTools.lectureFichier(f);
	 	...
	 	StrategyRadar r=new StrategyRadar(new RadarDijkstra(v,circuit,thetas)); 
	...
	public static void main(String[] args) throws Exception{
		File f =new	File( "8_safe.trk" ) ;
		SimulationRadarDijkstra simu= new SimulationRadarDijkstra(f);
		simu.run();
		ArrayList<Commande> liste= simu.getRecord();
		CommandeSauv.saveListeCommande(liste, "listeCommandeDijk");
		}
